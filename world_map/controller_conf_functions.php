...
function save_controller_info($options) {
	...
	$fh = fopen(self::$uptime_controller_conf_file, 'w') or die("Couldn't open file '{self::$uptime_controller_conf_file}'");	// overwrite
...
function load_controller_info($options) {
	$fh = fopen(self::$uptime_controller_conf_file, 'r') or die("Couldn't read file '{self::$uptime_controller_conf_file}'");	// overwrite
