...
<table class="outer">
	<tr>
		<td width="350px" class="outer" style="border: 0px;">
			...
			<table style="border: 0px;" class="menu">
				<tr>
					<td valign="top" class="menu" style="height: 75px;">
						<a href="manage_dashboards.php">Go Back</a><br /><br />
						...
						<form name="formSetBackground">
							<select id="bgList" name="bgName" onchange="setBGOnSVG();">
								...
								<option value="backgrounds/{$background}">{$background}</option>
								{/foreach}
							</select>
				...
				<tr valign="top">
					<td class="menu" style="height: 150px;">
						...
						<form name="formElementInfo">
							...
							<tr>
								<td>&nbsp;</td>
								<td><input type="button" name="RemoveElement" value="Remove" id="removeButton" onclick="removeElement();"  disabled /></td>
							</tr>
							</table>
						</form>
					</td>
